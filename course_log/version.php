 ...
 * Version info
 *
 * This File contains information about the current version of coursereport/logs
 *
...
$plugin->component = 'coursereport_course_log';  // Full name of the plugin (used for diagnostics)
